      ...
      <div className="bg-gradient">
        ...
        <main className="flex h-full flex-col p-4">
          <Accordion type="multiple" className="flex flex-col gap-2">
            ...
            <CustomAccordion
              value="item-1"
              title="1. CHE COS'È AUGMENTIN E A CHE COSA SERVE"
            >
              <div>
            ...
            <CustomAccordion
              value="item-2"
              title="2. PRIMA DI PRENDERE AUGMENTIN"
            >
            ...
            <CustomAccordion value="item-3" title="3. COME PRENDERE AUGMENTIN">
              <div className="text-brand-red">
            ...
            <CustomAccordion
              value="item-4"
              title="4. COME CONSERVARE AUGMENTIN"
            >
              <div>
            ...
            <CustomAccordion
              value="item-5"
              title="5. POSSIBILI EFFETTI INDESIDERATI"
            >
              <div>
...
Effetti indesiderati rari possono essere visibili dagli esami del sangue:
 ...
 basso numero di globuli bianchi
            ...
            <CustomAccordion value="item-6" title="6. ALTRE INFORMAZIONI">
              <div>
                <p>
